...
- **TP-Link Router WR802N (modalità WISP)**: accesso WAN e rete locale della fabbrica
...
- gestione ordini  
- stato fabbrica in tempo reale  
- avanzamento produzione  
- lettura dati NFC  
- streaming telecamera live  
- telemetria sensori ambientali

**Node-RED Dashboard (rete locale):**
- calibrazione stazioni e sensori  
- visualizzazione posizioni motori  
- reset errori e diagnostica  
- configurazione parametri operativi  
- HMI locale per supervisione
...
## 1.7 Riferimenti alla Documentazione

Questo documento integra informazioni provenienti da:

- **Manuali ufficiali Fischertechnik:**
  - *Learning Factory 4.0 24V – Accompanying Booklet*
  - *Training Factory Industry 4.0 24V – Commissioning Guide*
  
- **Repository software ufficiale:**
  - GitHub: [fischertechnik/plc_training_factory_24v](https://github.com/fischertechnik/plc_training_factory_24v)

- **Standard e protocolli industriali:**
  - OPC UA (OPC Unified Architecture)
  - MQTT (Message Queuing Telemetry Transport)
  - NFC/RFID ISO/IEC 14443
